...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <!-- Search Form -->
        <form class="row mb-3" method="GET" action="<?php echo e(route('products.index')); ?>">
            <div class="col-md-10 col-7">
                <input type="text" name="search" class="form-control" placeholder="Tìm theo mã SP hoặc tên sản phẩm..." value="<?php echo e(old('search', $search ?? '')); ?>">
            </div>
